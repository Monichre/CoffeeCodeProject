...
define('client/tests/components/plaid-call.jshint', ['exports'], function (exports) {
  ...
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/plaid-call.js should pass jshint.\ncomponents/plaid-call.js: line 10, col 38, Missing semicolon.\ncomponents/plaid-call.js: line 81, col 50, Missing semicolon.\ncomponents/plaid-call.js: line 94, col 11, Missing semicolon.\n\n3 errors');
  });
});
define('client/tests/components/transaction-tile.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint | components/transaction-tile.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/transaction-tile.js should pass jshint.');
  });
});
